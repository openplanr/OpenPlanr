...
test('real browser keeps dynamic artifacts useful while hostile capabilities fail closed', {
  ...
  // Native keyboard activation also works when the canvas scales an iframe;
  // frame-locator pointer coordinates can miss the transformed control in Chrome.
  await main.locator('#external-self').focus();
