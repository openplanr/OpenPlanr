...
test('Phase 6 packs and runs the complete governed loop in an isolated public consumer', { timeout: 120_000 }, () => {
  ...
  for (const required of [
    ...
    'lib/operate/governed-extensions-v2.mjs', 'lib/operate/governed-extensions-v2.d.mts',
    'lib/operate/reference-governed-executors-v2.mjs', 'lib/operate/reference-governed-executors-v2.d.mts',
    'lib/operate/governed-execution-v2.mjs', 'lib/operate/governed-execution-v2.d.mts',
    'lib/operate/governed-recovery-v2.mjs', 'lib/operate/governed-recovery-v2.d.mts',
    'lib/operate/execution-verification-v2.mjs', 'lib/operate/execution-verification-v2.d.mts',
  ...
  for (const name of [
    'authorization-v2', 'policy-v2', 'approvals-v2', 'governed-extensions-v2',
    'reference-governed-executors-v2', 'governed-execution-v2', 'governed-recovery-v2',
  ...
  for (const forbidden of [
    './operate/executor-v2', './operate/capability-v2', './operate/approval-bypass-v2',
  ]) assert.equal(metadata.exports[forbidden], undefined, `${forbidden}: no ambient-authority facade`);

  const verifierPath = join(installedPackage, 'conformance', 'verify-operate-v2-governed-execution.mjs');
  const verifierSource = readFileSync(verifierPath, 'utf8');
  assert.doesNotMatch(verifierSource, /(?:file:|\/Users\/|\.planr\/|\.env|process\.env)/u,
  ...
  for (const [, specifier] of verifierSource.matchAll(/from '([^']+)'/gu)) {
    ...
    assert.notEqual(metadata.exports[`./${specifier.slice('planr-pipeline/'.length)}`], undefined,
