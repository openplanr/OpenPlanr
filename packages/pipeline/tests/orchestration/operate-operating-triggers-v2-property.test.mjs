...
test('trigger/scenario construction rejects duplicate identities before any runtime transaction', () => {
  ...
  const common = {
    ...
    snapshotId: seed.result.snapshot.snapshotId, sourceArtifactId: seed.sourceArtifactId,
    assumptionIds: [seed.assumption.assumptionId], evidenceRefIds: [seed.evidenceRef.evidenceRefId],
  };
  const scenario = {
    ...value, ...common,
    base: { ...value.base, assumptionIds: common.assumptionIds, evidenceRefIds: common.evidenceRefIds },
    upside: { ...value.upside, assumptionIds: common.assumptionIds, evidenceRefIds: common.evidenceRefIds },
    downside: { ...value.downside, assumptionIds: common.assumptionIds, evidenceRefIds: common.evidenceRefIds },
  };
