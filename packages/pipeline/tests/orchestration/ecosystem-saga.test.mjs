...
const steps = [
  {
    ...
    action: 'land shared protocol contract',
    dependsOn: [],
  ...
  },
  {
    ...
    action: 'publish generated runtime guidance',
...
test('ecosystem saga reveals only dependency-safe deterministic work', () => {
  let saga = createEcosystemSaga({
    id: 'SAGA-SPEC-002',
    subject: 'runtime foundation release',
    participants,
    steps,
    createdAt: at,
  });
...
function releaseParticipant(id, repository, repoLocalSpecId, targetVersion, packageName) {
  return {
    ...
    sourceVersion: null,
    targetVersion,
    targetBranch: 'release/runtime-foundation',
    commit: null,
