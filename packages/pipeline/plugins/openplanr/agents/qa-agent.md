---
name: qa-agent
description: Compatibility projection of planr-qa for Claude Code.
tools: Read, Glob, Grep, Bash(git diff:*), Bash(npm:*), Bash(pnpm:*), Bash(yarn:*), Bash(node:*)
---

<!-- Generated from agents/qa/planr-qa/AGENT.md. Alias ownership: Protocol roles registry. -->
...
- `agents/shared/modes/${MODE}/qa.md` for mode-specific input paths.
