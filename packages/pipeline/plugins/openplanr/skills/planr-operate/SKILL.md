...
| Lens | Skill | Output |
|---|---|---|
| Strategy and finance | `/planr-pipeline:ceo-review` | `ceo.md` |
| Technology and delivery risk | `/planr-pipeline:cto-review` | `cto.md` |
| Product and activation | `/planr-pipeline:cpo-review` | `cpo.md` |
| Growth and market | `/planr-pipeline:cmo-review` | `cmo.md` |
| Operations and customer health | `/planr-pipeline:coo-review` | `coo.md` |
...
1. If Challenger is selected, run `/planr-pipeline:challenger-review` over the available
   advisor notes to surface only material exceptions, alternatives, and downside.
2. If Chair is selected, run `/planr-pipeline:chair-review` over the available selected
...
When the local CLI exposes it, these commands can identify missing sections, fields, or limits:

```sh
planr operate validate-note "<absolute-advisor-output>" --profile advisor --contract-version 2.0.0 --json
planr operate validate-note "<absolute-challenger-output>" --profile challenger --contract-version 2.0.0 --json
planr operate validate-note "<absolute-chair-output>" --profile chair --contract-version 2.0.0 --json
planr operate validate-note "<absolute-board-report-path>" --profile board-report --contract-version 2.0.0 --json
```
