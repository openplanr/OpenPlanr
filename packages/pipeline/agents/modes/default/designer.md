<!-- agents/shared/modes/default/designer.md: default-mode-only content for designer-agent. Loaded by agents/designer-agent.md when MODE=default. T-002 of SPEC-002. -->
