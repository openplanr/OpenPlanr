---
name: devops-agent
description: Compatibility projection of planr-devops for Claude Code.
tools: Read, Glob, Write, Edit
---

<!-- Generated from agents/post-build/planr-devops/AGENT.md. Alias ownership: Protocol roles registry. -->
...
- `agents/shared/modes/${MODE}/devops.md` — mode-specific planning and implementation context
...
`${CLAUDE_PLUGIN_ROOT}/stacks/devops/*.md`. Use the files that match the
...
- Read only the relevant `${CLAUDE_PLUGIN_ROOT}/stacks/devops/*.md` guidance
