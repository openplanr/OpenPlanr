---
name: db-agent
description: Compatibility projection of planr-database for Claude Code.
tools: Read, Grep, Glob, Bash(psql:*), Bash(mysql:*), Bash(sqlite3:*), Bash(mongosh:*), Bash(mongo:*), Write
---

<!-- Generated from agents/po/preflight/planr-database/AGENT.md. Alias ownership: Protocol roles registry. -->
