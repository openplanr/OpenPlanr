...
function assertPortableRuntimePurity(relativePath, text) {
  const portableV2 =
    ...
    /^lib\/operate\/runtime-foundation\/(?:authority|evidence-state|execution|intelligence|protocol|(?:authority|evidence-state|intelligence|workflow)-events)\.mjs$/.test(
      relativePath,
    ) ||
