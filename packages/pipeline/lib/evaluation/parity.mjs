...
/** The package-owned compatibility manifest against its generated bytes. */
export function compareGeneratedAssets({ repoRoot }) {
  const catalog = readProfessionalSkillsCatalog({ projectRoot: repoRoot });
  const generated = renderProfessionalSkillsBundle({ projectRoot: repoRoot });
  const mismatches = [];
  let present = 0;
 ...
 */
export function buildDeclaredArchive({ repoRoot }) {
  const catalog = readProfessionalSkillsCatalog({ projectRoot: repoRoot });
