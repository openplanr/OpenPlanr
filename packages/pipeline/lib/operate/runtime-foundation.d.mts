...
export interface OperateRuntimeGuardContextV2 extends Omit<OperateAuthorityContextV2, 'capabilities' | 'actor'> {
  capabilities?: Array<string | import('planr-pipeline/protocol').OperateVersionedIdentityV2>;
...
export function assertOperatingExecuteOperationV2(input: {
  ...
  configuredPolicies: readonly import('planr-pipeline/protocol').OperatingActionPolicyV2[];
...
export interface OperatingAssignmentClaimResultV2 {
  ...
  response: import('planr-pipeline/protocol').OperatingAssignmentClaimV2;
...
export function createEmptyOperatingRuntimeStateV2(
  generatedAt?: string,
  authority?: {
    actionPolicies?: readonly import('planr-pipeline/protocol').OperatingActionPolicyV2[];
    approvalRequirements?: readonly import('planr-pipeline/protocol').OperatingApprovalRequirementV2[];
  },
): OperatingRuntimeStateV2;
...
export function assertOperatingRollbackAuthorityChainV2(input: {
  ...
  plan: import('planr-pipeline/protocol').OperatingRollbackPlanV2;
  ...
  result: import('planr-pipeline/protocol').OperatingRollbackResultV2 | null;
