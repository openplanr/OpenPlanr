...
export function closeVerifiedOperatingCycleV2(options: {
  cycle: OperatingCycleV2;
  actions: readonly OperatingActionV2[];
  verificationPlans: readonly import('planr-pipeline/protocol').OperatingActionVerificationPlanV2[];
  governedOperations: readonly import('planr-pipeline/protocol').OperatingGovernedOperationV2[];
