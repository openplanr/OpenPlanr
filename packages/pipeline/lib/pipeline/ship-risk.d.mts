...
export interface ShipRiskClassification {
  ...
  selectedSpecialists: ShipSpecialistId[];
  reviewerRoster: Array<'qa-agent' | ShipSpecialistId>;
  browserQa: {
    required: boolean;
    triggers: BrowserSurface[];
...
export declare function assertSpecialistReviewResult(
  value: unknown,
  options: { classification: ShipRiskClassification; candidateDigest: `sha256:${string}` },
): unknown;
