export interface ContextEnvelopeObjective {
  summary: string;
  userValue: string;
}
export interface ContextEnvelopeDecision {
  decision: string;
  rationale?: string;
}
export interface ContextEnvelopeRepository {
  name: string;
  role: string;
}
...
export interface ContextEnvelopeDependency {
  task: string;
...
export type ContextEnvelopeInput = Partial<
  Omit<ContextEnvelopeV1, 'schemaVersion' | 'boundaries'>
> & {
  objective: ContextEnvelopeObjective;
...
export declare function buildContextEnvelope(
