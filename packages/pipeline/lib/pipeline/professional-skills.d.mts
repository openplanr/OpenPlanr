...
export type ProfessionalSkillAuthority =
  ...
  | 'quality-evidence';
export interface ProfessionalSkillContractRef { id: string; version: string }
...
export interface ProfessionalSkillsManifest {
  ...
  skills: Array<Omit<ProfessionalSkillCatalogRow, 'sourceSnapshot' | 'hosts'> & {
    assets: Array<{ host: ProfessionalSkillHost; entrypoint: string; path: string; digest: `sha256:${string}` }>;
  }>;
