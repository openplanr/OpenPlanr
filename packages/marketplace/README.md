...
> [openplanr/OpenPlanr](https://github.com/openplanr/OpenPlanr) under `packages/marketplace/`.
...
Resolved component versions: pipeline 0.39.0, CLI 1.22.0, skills 1.24.0, marketplace 1.9.0.
