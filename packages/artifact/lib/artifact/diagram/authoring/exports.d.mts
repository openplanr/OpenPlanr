import type { DiagramAuthoringBundle, DiagramAuthoringManifest, DiagramAuthoringValidationError } from '@openplanr/protocol/diagram-authoring-contracts';
...
export interface AuthoredDiagramExportOptions {
  ...
  rasterize?: (svg: string, options: { scale: number; theme: AuthoredDiagramTheme }) => { bytes: Uint8Array } | Promise<{ bytes: Uint8Array }>;
}
...
export declare function exportAuthoredDiagram(bundle: DiagramAuthoringBundle, options: AuthoredDiagramExportOptions): Promise<AuthoredDiagramExportResult | AuthoredDiagramExportFailure>;
/**
 ...
 */
export declare function verifyAuthoredDiagramExports(bundle: DiagramAuthoringBundle, options: Omit<AuthoredDiagramExportOptions, 'rasterize'>): Promise<VerifiedAuthoredDiagramExports | AuthoredDiagramExportFailure>;
