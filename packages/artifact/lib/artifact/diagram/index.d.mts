...
export type DiagramSourceChoice =
  | 'ir'
  | 'mermaid'
  | 'excalidraw'
  | 'accept-ir'
...
export declare function routeDiagramIntent(
  input?: Record<string, unknown>,
): Readonly<Record<string, unknown>>;
export declare function planDiagramQuality(
  document: Record<string, unknown>,
  metrics?: Record<string, unknown>,
): Record<string, unknown>;
export declare function validateDiagramSvg(
  svg: string,
  options?: Record<string, unknown>,
): Readonly<{
  ok: boolean;
...
export declare function assertDiagramSvg(
  svg: string,
  options?: Record<string, unknown>,
): Readonly<Record<string, unknown>>;
...
export declare const MERMAID_EXPORT_CAPABILITIES: Readonly<
...
export declare function renderDiagramSvg(
  document: DiagramDocument,
  options?: Record<string, unknown>,
): Readonly<{ svg: string; scene: Readonly<Record<string, unknown>> }>;
export declare function renderDiagramHtml(
  document: DiagramDocument,
  svg: string,
  options?: Record<string, unknown>,
): string;
export declare function renderDiagramPng(
  svg: string,
  options?: Record<string, unknown>,
): DiagramPng;
export declare function inspectDiagramPng(
  bytes: Uint8Array,
): Readonly<{ width: number; height: number; byteLength: number }>;
export declare function renderDiagramOutputs(document: DiagramDocument): DiagramRenderedOutputs;
export declare function createRenderQualityReport(
  document: DiagramDocument,
  input: Record<string, unknown>,
): Readonly<Record<string, unknown>>;
export declare function createFidelityReport(
  document: DiagramDocument,
  input: Record<string, unknown>,
): Readonly<Record<string, unknown>>;
export declare function mermaidCapability(grammarId: string): Readonly<Record<string, string>>;
export declare function exportDiagramMermaid(
  document: DiagramDocument,
): Readonly<{ source: string | null; report: Readonly<Record<string, unknown>> }>;
...
export declare function exportDiagramExcalidraw(
  document: DiagramDocument,
): Readonly<{ scene: Record<string, unknown> | null; report: Readonly<Record<string, unknown>> }>;
export declare function renderExcalidrawSceneSvg(
  scene: Record<string, unknown>,
  options?: Record<string, string>,
): Readonly<{ svg: string; scene: Readonly<Record<string, unknown>> }>;
export declare function renderDiagram(
  document: DiagramDocument,
  options?: { outputRoot?: string; slug?: string },
): Promise<DiagramRenderCompletion>;
export declare function rerenderDiagram(options: {
  outputRoot?: string;
  slug: string;
  acceptSource?: DiagramSourceChoice | null;
}): Promise<DiagramRenderCompletion>;
export declare function inspectDiagram(options: {
  outputRoot?: string;
  slug: string;
}): Promise<DiagramInspection>;
export declare function checkDiagram(options: {
  outputRoot?: string;
  slug: string;
}): Promise<DiagramInspection>;
...
export declare function createDiagramConsumerReference(
  manifestPath: string,
  options: {
    consumer: 'specification' | 'documentation' | 'pdf';
    consumerPath?: string | null;
    preferredFormat?: 'svg' | 'png';
  },
): Promise<DiagramConsumerAttachment>;
export declare function createDiagramSpecificationReference(
  manifestPath: string,
  options?: Record<string, unknown>,
): Promise<DiagramConsumerAttachment>;
export declare function createDiagramDocumentationReference(
  manifestPath: string,
  options?: Record<string, unknown>,
): Promise<DiagramConsumerAttachment>;
export declare function createDiagramPdfAttachment(
  manifestPath: string,
  options?: Record<string, unknown>,
): Promise<DiagramConsumerAttachment>;
export declare function createDiagramArtifactEnvelope(
  manifestPath: string,
  options?: { nativeViewport?: boolean },
): Promise<
  Readonly<{
...
export { adoptMermaidCopy, exportMermaidCopy, previewMermaidCopy } from './authoring/index.mjs';
