...
> DEV agents use these commands after coherent changes. They diagnose observed
> failures, fix the cause, and rerun the relevant checks. Empty optional commands
> are skipped.
