/**
 * Regression tests for user-story prompt/template mismatch.
 *
 * The template at src/templates/stories/user-story.md.hbs prepends the
 * "As a" / "I want to" / "So that" prefixes itself. Previously,
...
describe('user-story.md.hbs rendering', () => {
...
describe('gherkin.feature.hbs rendering', () => {
