...
export abstract class BaseGenerator {
  ...
  /** Render the one host-neutral implementation policy used by every adapter. */
  protected renderImplementationGuidance(): Promise<string> {
    return renderTemplate(
      'rules/shared/implementation-guidance.md.hbs',
      {
