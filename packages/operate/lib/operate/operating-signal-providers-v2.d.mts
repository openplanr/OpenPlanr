...
export function selectOperatingSnapshotProviderV2(
  registry: OperateExtensionRegistryV2 | undefined,
  request: {
    providerId: string;
    providerVersion: string;
    domainContract: { apiDomainId: string; id: string; version: string };
  },
): OperatingSignalProviderSelectionV2;
...
export function createOperatingSnapshotCandidateV2(input: {
  registry?: OperateExtensionRegistryV2;
  providerId: string;
  providerVersion: string;
  snapshot: OperatingSnapshotV2;
  state: OperatingModelStateV2;
  acceptedArtifacts: readonly OperatingArtifactV2[];
}):
  | OperatingSignalProviderSelectionV2
  | {
      status: 'candidate';
      provider: Readonly<Record<string, unknown>>;
      candidate: OperatingSnapshotV2;
    };
export function createOperatingMetricObservationCandidateV2(input: {
  registry?: OperateExtensionRegistryV2;
  providerId: string;
  providerVersion: string;
  metric: OperatingMetricV2;
  ...
  | {
      status: 'candidate';
      provider: Readonly<Record<string, unknown>>;
      candidate: OperatingMetricObservationV2;
    };
export function createOperatingVerificationCandidateV2(input: {
  registry?: OperateExtensionRegistryV2;
  providerId: string;
  providerVersion: string;
  verificationPlan: OperatingActionVerificationPlanV2;
  outcome: OperatingOutcomeV2;
  acceptedArtifacts: readonly OperatingArtifactV2[];
}):
  | OperatingSignalProviderSelectionV2
  | {
