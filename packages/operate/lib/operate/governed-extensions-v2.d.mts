...
export interface OperatePolicyProviderSelectionV2 extends OperateGovernedSelectionBaseV2 {
  providerId: string;
  providerVersion: string;
  policyRef?: OperateVersionedIdentityV2;
}
...
export type OperateGovernedSelectionResultV2<T> =
  | {
      ...
      readonly registration: Readonly<T>;
      readonly reasonCode: 'exact-registration-available';
      readonly fallback: null;
    }
  | {
      readonly status: 'unavailable';
      readonly registration: Readonly<T> | null;
      readonly reasonCode: string;
      readonly fallback: { readonly kind: 'unavailable'; readonly errorCode: string };
    };
...
export const OPERATE_GOVERNED_EFFECT_RANK_V2: Readonly<
  Record<OperateGovernedEffectClassV2, number>
>;
export class OperatingGovernedExtensionErrorV2 extends Error {
  code: string;
...
export function createOperateGovernedExtensionRegistryV2(
  input?: Partial<OperateGovernedExtensionRegistryV2>,
): OperateGovernedExtensionRegistryV2;
export function canonicalizeOperateGovernedExtensionRegistryV2(
...
): OperateCapabilityProviderRegistrationV2 | null;
export function findOperatePolicyProviderRegistrationV2(
  registry: OperateGovernedExtensionRegistryV2,
  providerId: string,
  options: { providerVersion: string },
): OperatePolicyProviderRegistrationV2 | null;
export function findOperateExecutorRegistrationV2(
  registry: OperateGovernedExtensionRegistryV2,
  executorId: string,
  options: { executorVersion: string },
): OperateExecutorRegistrationV2 | null;
export function selectOperateCapabilityProviderV2(
  registry: OperateGovernedExtensionRegistryV2,
  criteria: OperateCapabilityProviderSelectionV2,
): OperateGovernedSelectionResultV2<OperateCapabilityProviderRegistrationV2>;
export function selectOperatePolicyProviderV2(
  registry: OperateGovernedExtensionRegistryV2,
  criteria: OperatePolicyProviderSelectionV2,
): OperateGovernedSelectionResultV2<OperatePolicyProviderRegistrationV2>;
export function selectOperateExecutorV2(
  registry: OperateGovernedExtensionRegistryV2,
  criteria: OperateExecutorSelectionV2,
): OperateGovernedSelectionResultV2<OperateExecutorRegistrationV2>;
export function classifyOperateExecutorRecoveryCapabilityV2(
...
export function assertOperateExecutorRegistrationV2(
  executor: OperateExecutorRegistrationV2,
  options?: { registry?: OperateGovernedExtensionRegistryV2 },
): Readonly<OperateExecutorRegistrationV2>;
export function createTrustedExecutorBindingV2(input: {
  selection: OperateGovernedSelectionResultV2<OperateExecutorRegistrationV2>;
  trustedHost: OperateTrustedExecutorHostV2;
}): Readonly<OperateTrustedExecutorBindingV2>;
export function assertTrustedExecutorBindingV2(
  binding: OperateTrustedExecutorBindingV2,
  input: { executor: OperateExecutorRegistrationV2 },
): Readonly<OperateTrustedExecutorBindingV2>;
