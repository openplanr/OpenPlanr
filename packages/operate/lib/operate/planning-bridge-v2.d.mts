...
export function createOperatingDeliveryRouteV1(input: {
  state: OperatingRuntimeStateV2;
  action: OperatingActionV2;
  route: OperatingDeliveryRouteV1['route'];
  rationale: string;
  createdAt?: string;
}): OperatingDeliveryRouteV1;
export function assertOperatingDeliveryRouteRevisionV1(
  previous: OperatingDeliveryRouteV1,
  next: OperatingDeliveryRouteV1,
): OperatingDeliveryRouteV1;
export function buildOperatingPlanningProposalV1(
  state: OperatingRuntimeStateV2,
  input: {
    ...
    framing: OperatingPlanningProposalV1['framing'];
    actor: OperatingPlanningProposalV1['actor'] & {
...
export function assertOperatingPlanningProposalV1(
  proposal: OperatingPlanningProposalV1,
): OperatingPlanningProposalV1;
export function confirmOperatingPlanningProposalV1(
  ...
  confirmation: {
    ...
    proposalRevision: 1;
    proposalHash: string;
    eventHead: OperatingPlanningProposalV1['eventHead'];
    previewDigest: string;
    confirmedAt: string;
  },
): OperatingPlanningProposalV1;
export function createOperatingOriginV1(input: {
  proposal: OperatingPlanningProposalV1;
  spec: OperatingOriginV1['spec'];
  actor: OperatingOriginV1['actor'];
  transaction: OperatingOriginV1['transaction'];
  createdAt: string;
}): OperatingOriginV1;
...
export function assertOperatingDeliveryEvidenceV1(
  evidence: OperatingDeliveryEvidenceV1,
): OperatingDeliveryEvidenceV1;
