...
export interface OperateExperienceScopeV1 {
  scopeId: string;
  domainId: string;
...
export function rankOperateAttentionV2(
  view: OperateExperienceViewV1,
): OperateExperienceViewV1['attention'];
export function createOperateExperiencePreviewV1(
  ...
  options: {
    ...
    view: OperateExperienceViewV1;
    actionDigest: string;
    authority: OperateExperiencePreviewV1['authority'];
    consequence?: string;
...
export function buildOperateExperienceLivePatchV2(
  previous: OperateExperienceViewV1,
  next: OperateExperienceViewV1,
  options?: { createdAt?: string },
): OperateExperienceLivePatchV1;
export function applyOperateExperienceLivePatchV2(
  previous: OperateExperienceViewV1,
  patch: OperateExperienceLivePatchV1,
  next: OperateExperienceViewV1,
): OperateExperienceViewV1;
