...
export interface AgentRuntimeManifestV2 {
  ...
  fallback:
    | { kind: 'unavailable' }
    | { kind: 'runtime'; runtimeId: string; runtimeVersion: string };
}
...
export const PUBLIC_OPERATE_DOMAIN_BINDINGS_V2: Readonly<
  Record<
    'business' | 'software',
    {
...
export function createOperateExtensionRegistryV2(
  input?: Partial<OperateExtensionRegistryV2> & { allowSyntheticDomains?: boolean },
): OperateExtensionRegistryV2;
export function canonicalizeOperateExtensionRegistryV2(
  registry: OperateExtensionRegistryV2,
): OperateExtensionRegistryV2;
export function findOperateDomainRegistrationV2(
  registry: OperateExtensionRegistryV2,
  domainId: string,
  options: { domainVersion: string },
): OperateDomainRegistrationV2 | null;
export function findAgentRuntimeManifestV2(
  registry: OperateExtensionRegistryV2,
  runtimeId: string,
  options: { runtimeVersion: string },
): AgentRuntimeManifestV2 | null;
export function findOperateSnapshotProviderRegistrationV2(
  registry: OperateExtensionRegistryV2,
  providerId: string,
  options: { providerVersion: string },
): OperateSnapshotProviderRegistrationV2 | null;
export function findOperateMetricProviderRegistrationV2(
  registry: OperateExtensionRegistryV2,
  providerId: string,
  options: { providerVersion: string },
): OperateMetricProviderRegistrationV2 | null;
export function findOperateVerificationProviderRegistrationV2(
  registry: OperateExtensionRegistryV2,
  providerId: string,
  options: { providerVersion: string },
): OperateVerificationProviderRegistrationV2 | null;
export function selectAgentRuntimeManifestV2(
  registry: OperateExtensionRegistryV2,
  runtimeId: string,
  options: { runtimeVersion: string },
):
  | {
      ...
      manifest: AgentRuntimeManifestV2;
      fallback: { runtimeId: string; runtimeVersion: string } | null;
    }
