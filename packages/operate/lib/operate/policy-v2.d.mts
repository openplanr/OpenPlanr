...
export const OPERATE_POLICY_TIER_PRECEDENCE_V2: Readonly<
  Record<OperatePolicyTierV2, 100 | 200 | 300>
>;
export const OPERATE_POLICY_OUTCOME_STRENGTH_V2: Readonly<
  Record<OperateGovernedPolicyOutcomeV2, number>
>;
...
export type OperatingActionPolicyInputV2 = Omit<
  OperatingActionPolicyV2,
  'kind' | 'schemaVersion' | 'protocolVersion' | 'precedence' | 'narrowingOnly' | 'policyHash'
>;

export function createOperatingActionPolicyV2(
  input: OperatingActionPolicyInputV2,
): Readonly<OperatingActionPolicyV2>;
export function assertOperatingActionPolicyV2(
  policy: OperatingActionPolicyV2,
): Readonly<OperatingActionPolicyV2>;
...
export function evaluateOperatingActionPolicyV2(
  input: OperatingPolicyEvaluationInputV2,
