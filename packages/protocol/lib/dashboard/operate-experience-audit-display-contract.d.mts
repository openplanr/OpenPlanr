...
export type OperateAuditEvidenceV1 = Readonly<
  Omit<OperateExperienceEvidenceV1, 'deepLink' | 'causalLinks'> & {
    ...
    causalLinks: readonly NullableDeepLink<OperateExperienceEvidenceV1['causalLinks'][number]>[];
  }
>;
...
export type OperateAuditClaimV1 = Readonly<
  Omit<OperateExperienceClaimV1, 'deepLink' | 'causalLinks'> & {
    deepLink: string | null;
    causalLinks: readonly NullableDeepLink<OperateExperienceClaimV1['causalLinks'][number]>[];
  }
>;
...
export type OperateAuditOutcomeV1 = Readonly<
  Omit<OperateExperienceOutcomeV1, 'deepLink' | 'decision' | 'execution' | 'rollback'> & {
    deepLink: string | null;
    decision: null | NullableDeepLink<NonNullable<OperateExperienceOutcomeV1['decision']>>;
    execution: readonly NullableDeepLink<OperateExperienceOutcomeV1['execution'][number]>[];
    rollback: readonly NullableDeepLink<OperateExperienceOutcomeV1['rollback'][number]>[];
  }
>;

type AuditPayloadBase = Readonly<
  Omit<OperateExperienceSurfaceBaseV1, 'surface' | 'mutationEnabled' | 'eventHead'> & {
...
type OperateAuditReplayV1 = Readonly<
  Omit<OperateExperienceReplayV1, 'checkpoint' | 'finalHead'> & {
    checkpoint: null | Readonly<
      Omit<NonNullable<OperateExperienceReplayV1['checkpoint']>, 'eventHead'> & {
        eventHead: OperateAuditEventHeadV1;
      }
    >;
...
export const OPERATE_EXPERIENCE_AUDIT_DISPLAY_SURFACE_SCHEMA_V1: Readonly<Record<string, unknown>>;
