...
export type OperateExperienceSurfaceStatusV1 = OperateExperienceViewV1['status'];
...
export function validateOperateExperienceSurfaceV1(value: unknown): ProtocolValidationError[];
export function assertOperateExperienceSurfaceV1<T>(value: T): T;
export const OPERATE_EXPERIENCE_SURFACE_SCHEMA_V1: Readonly<Record<string, JsonValue>>;
