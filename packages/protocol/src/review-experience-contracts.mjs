...
/**
 * A published schema reopened for its next version.
 * @typedef {{ properties: Record<string, unknown>; required: string[]; [key: string]: unknown }} MutableSchema
 */

/** @type {typeof import('./review-experience-contracts.d.mts').DESIGN_REVIEW_CONTEXT_SCHEMA} */
...
/** @type {typeof import('./review-experience-contracts.d.mts').DESIGN_FINGERPRINT_SCHEMA} */
...
const bundleV11 = {
  .../** @type {MutableSchema} */ (structuredClone(DESIGN_REVIEW_BUNDLE_SCHEMA)),
...
/** @type {typeof import('./review-experience-contracts.d.mts').DESIGN_HANDOFF_CONTENT_SCHEMA} */
...
/** @type {typeof import('./review-experience-contracts.d.mts').DESIGN_HANDOFF_SCHEMA} */
...
/** @type {typeof import('./review-experience-contracts.d.mts').DESIGN_REVIEW_METADATA_PAYLOAD_SCHEMA} */
export const DESIGN_REVIEW_METADATA_PAYLOAD_SCHEMA = {
  ...schema(
...
const payloadV11 = {
  .../** @type {MutableSchema} */ (structuredClone(DESIGN_REVIEW_METADATA_PAYLOAD_SCHEMA)),
...
/** @type {typeof import('./review-experience-contracts.d.mts').DESIGN_REVIEW_METADATA_PAYLOAD_V11_SCHEMA} */
export const DESIGN_REVIEW_METADATA_PAYLOAD_V11_SCHEMA = payloadV11;

/** @returns {ReturnType<typeof import('./review-experience-contracts.d.mts').assertReviewExperience>} */
...
/** @returns {ReturnType<typeof import('./review-experience-contracts.d.mts').assertDesignReviewMetadata>} */
...
/** @returns {ReturnType<typeof import('./review-experience-contracts.d.mts').assertDesignReviewBundle>} */
...
/** @type {typeof import('./review-experience-contracts.d.mts').REVIEW_EXPERIENCE_SCHEMAS} */
