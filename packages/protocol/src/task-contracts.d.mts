export interface ProtocolSemanticDiagnostic {
  code: string;
  path: string;
  message: string;
}
export declare function validateTaskManifestSemantics(
  value: unknown,
  options?: object,
): ProtocolSemanticDiagnostic[];
...
export declare function validateTaskOutputSemantics(
  value: unknown,
  options?: { taskManifest?: any },
): ProtocolSemanticDiagnostic[];
