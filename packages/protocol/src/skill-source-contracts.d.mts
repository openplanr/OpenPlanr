...
export declare const SKILL_SOURCE_V16_REGISTRIES: Readonly<
  Record<
    string,
    Readonly<{
      kind: string;
  ...
  >
>;
export declare const DIAGRAM_V16_REGISTRIES: Readonly<
  Record<
    string,
    Readonly<{
      kind: string;
  ...
  >
>;
export declare const PROTOCOL_V16_REGISTRIES: Readonly<
  Record<
    string,
    Readonly<{
      kind: string;
  ...
  >
>;
export declare const SKILL_SOURCE_V17_REGISTRIES: Readonly<
  Record<
    string,
    Readonly<{
      kind: string;
