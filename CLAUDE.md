...
- [EPIC-001](.planr/epics/EPIC-001-openplanr-v13-security-dx-code-quality-hardening.md): openplanr v13 security dx code quality hardening

## Current Features

- [FEAT-001](.planr/features/FEAT-001-prompt-architecture-hardening-injection-protection.md): prompt architecture hardening injection protection
- [FEAT-002](.planr/features/FEAT-002-error-messages-user-guidance-enhancement.md): error messages user guidance enhancement
- [FEAT-003](.planr/features/FEAT-003-comprehensive-test-coverage-for-command-handlers.md): comprehensive test coverage for command handlers
- [FEAT-004](.planr/features/FEAT-004-code-quality-shared-utilities-consolidation.md): code quality shared utilities consolidation
