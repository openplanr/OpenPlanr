export type ArtifactType = 'epic' | 'feature' | 'story' | 'task' | 'quick' | 'backlog' | 'sprint' | 'adr' | 'checklist';
 ...
 */
export type LinearIssueEstimationType = 'notUsed' | 'fibonacci' | 'linear' | 'exponential' | 'tShirt';
...
export type StakeholderReportType = 'sprint' | 'weekly' | 'executive' | 'standup' | 'retro' | 'release';
 ...
 */
export type ReviseAuditOutcome = 'applied' | 'would-apply' | 'unchanged-by-agent' | 'skipped-by-agent' | 'skipped-by-user' | 'flagged' | 'failed' | 'demoted' | 'applied-from-plan' | 'stale-skipped' | 'conflict-skipped';
/**
