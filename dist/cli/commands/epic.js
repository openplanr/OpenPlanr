...
import { createArtifact, listArtifacts, updateArtifactFields, } from '../../services/artifact-service.js';
...
import { promptEditor, promptMultiText, promptSelect, promptText, } from '../../services/prompt-service.js';
...
export function registerEpicCommand(program) {
    ...
    epic
        ...
        try {
            ...
            logger.error(`Failed to update ${epicId}: ${err.message}`);
            process.exit(1);
        }
    });
}
