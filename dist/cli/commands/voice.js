...
export function registerVoiceCommand(program) {
    ...
    voice
        ...
        .option('--write <path>', 'write standup markdown to this path (relative to project or absolute)')
        .option('--edit', 'open generated markdown in $EDITOR before output/save (interactive only)')
        .option('--reload-file', 'after generating, offer to re-read --file from disk (interactive + --file only)')
