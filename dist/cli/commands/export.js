...
async function exportMarkdown(data, outputPath, overrideDir) {
    const content = await renderTemplate('export/planning-report.md.hbs', data, // Template data is inherently untyped
    overrideDir);
...
async function exportHTML(data, outputPath, overrideDir) {
    const content = await renderTemplate('export/planning-report.html.hbs', data, // Template data is inherently untyped
    overrideDir);
