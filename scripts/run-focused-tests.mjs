...
const steps = Object.freeze([
  { id: 'release-versioning-and-publication-boundaries', cwd: root, args: ['--test', 'tests/ecosystem-root/release-versioning.test.mjs', 'tests/ecosystem-root/plugin-manifest-versions.test.mjs', 'tests/release-train/plan.test.mjs', 'tests/release-train/notes.test.mjs', 'tests/release-train/marketplace.test.mjs', 'tests/release-train/lockfile.test.mjs', 'tests/ecosystem-root/publication-custody.test.mjs', 'conformance/migration/private-decisions.test.mjs', 'conformance/migration/archived-dashboard.test.mjs', 'conformance/migration/preservation-catalog.test.mjs'] },
