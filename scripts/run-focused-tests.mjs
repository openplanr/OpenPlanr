...
const steps = Object.freeze([
  ...
  { id: 'runtime-purity', cwd: root, args: ['scripts/skills/check-runtime-purity.mjs'] },
  {
    ...
    args: [
      ...
      'tests/protocol/design-handoff-contracts.test.mjs',
