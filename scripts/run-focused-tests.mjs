...
const steps = Object.freeze([
  { id: 'release-versioning-and-publication-boundaries', cwd: root, args: ['--test', 'tests/ecosystem-root/release-versioning.test.mjs', 'tests/ecosystem-root/publication-custody.test.mjs', 'conformance/migration/private-decisions.test.mjs', 'conformance/migration/preservation-catalog.test.mjs'] },
