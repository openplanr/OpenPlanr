...
| `@openplanr/artifact` | 0.2.1 | `packages/artifact` | private |
| `@openplanr/design` | 0.2.1 | `packages/design` | private |
| `@openplanr/skill-runtime` | 0.2.1 | `packages/skill-runtime` | private |
| `@openplanr/integrations` | 0.1.0 | `packages/integrations` | private |
| `@openplanr/dashboard-app` | 0.1.2 | `apps/dashboard` | private |

Compatibility invariants:

- `openplanr` uses the exact optional `planr-pipeline@0.45.1` dependency.
