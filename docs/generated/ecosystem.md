...
|---|---:|---|---|
| `openplanr` | 2.6.1 | `packages/cli` | public |
| `planr-pipeline` | 0.49.1 | `packages/pipeline` | public |
...
- `openplanr` uses the exact optional `planr-pipeline@0.49.1` dependency.
- The public pipeline retains 43 export keys and 229 root symbols.
