...
|---|---:|---|---|
| `openplanr` | 2.0.0 | `packages/cli` | public |
| `planr-pipeline` | 0.45.0 | `packages/pipeline` | public |
| `@openplanr/protocol` | 0.2.0 | `packages/protocol` | public |
| `@openplanr/operate` | 0.1.1 | `packages/operate` | private |
| `@openplanr/artifact` | 0.2.0 | `packages/artifact` | private |
| `@openplanr/design` | 0.2.0 | `packages/design` | private |
| `@openplanr/skill-runtime` | 0.2.0 | `packages/skill-runtime` | private |
| `@openplanr/integrations` | 0.1.0 | `packages/integrations` | private |
| `@openplanr/dashboard-app` | 0.1.1 | `apps/dashboard` | private |
