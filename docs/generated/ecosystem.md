...
|---|---:|---|---|
| `openplanr` | 2.6.2 | `packages/cli` | public |
| `planr-pipeline` | 0.50.0 | `packages/pipeline` | public |
| `@openplanr/protocol` | 0.6.0 | `packages/protocol` | public |
| `@openplanr/operate` | 0.1.5 | `packages/operate` | private |
| `@openplanr/artifact` | 0.3.0 | `packages/artifact` | private |
| `@openplanr/design` | 0.2.4 | `packages/design` | private |
