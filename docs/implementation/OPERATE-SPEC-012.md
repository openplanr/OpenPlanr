...
Release record binding for `openplanr@1.25.0`.

What changed in this release is in [CHANGELOG.md](../../CHANGELOG.md) under `1.25.0`.
The coordinated release record — participants, versions, published artifacts, and
canary evidence — is operation `OPERATE-SPEC-012` in
